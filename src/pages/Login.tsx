      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-block">
            <div className="bg-white text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-500 font-bold text-3xl px-4 py-2 rounded-lg shadow-lg">
              ShopIndia
            </div>
          </Link>
          <p className="text-white mt-2">Welcome back to India's favorite marketplace</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-3 px-4 rounded-lg font-semibold hover:shadow-lg transition-shadow disabled:opacity-50"
            >
